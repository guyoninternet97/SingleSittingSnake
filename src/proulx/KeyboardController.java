    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (!isLocked) {
            ...
            if (e.getKeyCode() == KeyEvent.VK_LEFT && attachedPanel.getHead().direction != PlayerTile.DIRECTION.RIGHT) {
                ...
                attachedPanel.getSnake().addChangePoint(new Pair<Integer, Integer>(attachedPanel.getHead().x, attachedPanel.getHead().y), PlayerTile.DIRECTION.LEFT);
                ...
                attachedPanel.getSnake().addChangePoint(new Pair<Integer, Integer>(attachedPanel.getHead().x, attachedPanel.getHead().y), PlayerTile.DIRECTION.RIGHT);
                ...
                attachedPanel.getSnake().addChangePoint(new Pair<Integer, Integer>(attachedPanel.getHead().x, attachedPanel.getHead().y), PlayerTile.DIRECTION.UP);
                ...
                attachedPanel.getSnake().addChangePoint(new Pair<Integer, Integer>(attachedPanel.getHead().x, attachedPanel.getHead().y), PlayerTile.DIRECTION.DOWN);
